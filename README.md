...
Credit Score, Age, Tenure, Balance,Number of Products, Credit Card Status, Active Membership, Estimated Salary and Geography
...
Bash
git clone https://github.com/SOBANASIVJI/streamlitapp.git
